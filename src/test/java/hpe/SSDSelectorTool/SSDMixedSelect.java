...
public class SSDMixedSelect extends BaseClass
{
	...
	@Test(priority = 3)
	public void ToVerifySelectMixedUse()
	{
		ssdWorkloadpage = new SSDWorkloadPage();
		ssdWorkloadpage.SelectMixedALL();
		driver.manage().timeouts().pageLoadTimeout(10, TimeUnit.SECONDS);
	...
	public void ToVerifySelectedWorkloadDisplays()
	{
		ssdServermodelpage = new SSDServermodelPage();
		driver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS);
		ssdServermodelpage.MixedTargetLoadDisplays();
	...
	@Test(priority = 8)
	public void ToVerifySelectMixedServerType()
	{
		ssdServermodelpage = new SSDServermodelPage();
		driver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS);
		Assert.assertTrue(ssdServermodelpage.MixedServerType(), "Server Type List is displayed");
	}
	@Test(priority = 9)
	public void ToVerifySelectMixedServerModelType()
	{
		ssdServermodelpage = new SSDServermodelPage();
		ssdServermodelpage.MixedServerModelType();
		driver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS);
	...
	@Test(priority = 19)
	public void ToVerifyFormFactorSelected()
	{
		ssdFormfactorpage = new SSDFormfactorPage();
	...
	/*@Test(priority = 23)
	public void ToVerifyMixedResultsDisplays()
	{
		ssdResultpage = new SSDResultPage();
		JavascriptExecutor MixedScrollDown = (JavascriptExecutor)driver;
		driver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS);
		...
		MixedScrollDown.executeScript("arguments[0].scrollIntoView();",ssdResultpage.SSDRequriementslink);
		String ActualSSDRequirmentLabel = "21 -  SSDs meet your requirements";
		String ExpectedSSDRequirmentLabel = ssdResultpage.SSDRequriementslink.getText();
	...
	public void ToVerifyRefineYourResults()
	{
		...
		System.out.println(ssdResultpage.ResultWriteSSDSelected() + "Write Intensive is Not Selected");
	...
	@Test(priority = 25)
	public void ToVerifyMixedNonMainstreamResults() throws InterruptedException
	{
		ssdResultpage = new SSDResultPage();
		JavascriptExecutor SSDResultsLink = (JavascriptExecutor)driver;
		SSDResultsLink.executeScript("arguments[0].scrollIntoView();",ssdResultpage.SSDRequriementslink);
		SSDResultsLink.executeScript("arguments[0].click()",ssdResultpage.SSDRequriementslink);
		Thread.sleep(1000);
		SSDResultsLink.executeScript("arguments[0].scrollIntoView()",ssdResultpage.ResultLink);
		SSDResultsLink.executeScript("arguments[0].click()", ssdResultpage.ResultLink);
		SSDResultsLink.executeScript("arguments[0].click()", ssdResultpage.NonMainstreamChk);
		//driver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS);
	/*	WebElement BestAvail = driver.findElement(By.xpath("//div[text()='Best Availability']"));
		JavascriptExecutor MixedSearchResultScroll = (JavascriptExecutor)driver;
		MixedSearchResultScroll.executeScript("arguments[0].scrollIntoView();",BestAvail); */
		//ssdResultpage.ResultPageMainstream();
		/*String SSDResultDisplays = ssdResultpage.SSDRequriementslink.getText();
		System.out.println(SSDResultDisplays);
		WebDriverWait NonMainstreamResultload =	new WebDriverWait(driver, 10);
		WebElement ExpectedSSDRequirmentLabel1 = driver.findElement(By.xpath("//*[@id=\"panel-ggroup3\"]/div/div[1]/h4/a"));
		ExpectedSSDRequirmentLabel1 = NonMainstreamResultload.until(ExpectedConditions.visibilityOf(ExpectedSSDRequirmentLabel1));
		String ActualSSDRequirmentLabel = "73 -  SSDs meet your requirements";
	//String ExpectedSSDRequirmentLabel2 = driver.findElement(By.xpath("//*[@id=\"panel-ggroup3\"]/div/div[1]/h4/a")).getText();
		Assert.assertEquals(ActualSSDRequirmentLabel, ExpectedSSDRequirmentLabel1); 
	/*	WebElement ExpectedDisplay = NonMainstreamResultload.until(ExpectedConditions.visibilityOf(ExpectedSSDRequirmentLabel1));
		String SSDResultDisplays = ssdResultpage.SSDRequriementslink.getText();
		System.out.println(SSDResultDisplays);
		String ActualSSDRequirmentLabel = "73 -  SSDs meet your requirements";
		String ExpectedSSDRequirmentLabel2 = driver.findElement(By.xpath("//*[@id=\"panel-ggroup3\"]/div/div[1]/h4/a")).getText();
		Assert.assertEquals(ActualSSDRequirmentLabel, ExpectedSSDRequirmentLabel2); */
	} 
