...
public class SSDVROSelect extends BaseClass
{
	...
	@Test(priority = 3)
	public void ToVerifySelectVROIntensive()
	{
		ssdWorkloadpage = new SSDWorkloadPage();
		ssdWorkloadpage.SelectVROALL();
		driver.manage().timeouts().pageLoadTimeout(10, TimeUnit.SECONDS);
	...
	{
		ssdServertypepage = new SSDServertypePage();
		Assert.assertTrue(ssdServertypepage.SelectedVROIntensive(),"Write-Intensive is Selected");
	...
	public void ToVerifySelectedWorkloadDisplays()
	{
		ssdServermodelpage = new SSDServermodelPage();
		driver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS);
		ssdServermodelpage.VROTargetLoadDisplays();
	...
	@Test(priority = 8)
	public void ToVerifySelectVROServerType()
	{
		ssdServermodelpage = new SSDServermodelPage();
		driver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS);
		Assert.assertTrue(ssdServermodelpage.VROServerType(), "Server Type List is displayed");
	}
	@Test(priority = 9)
	public void ToVerifySelectVROServerModelType()
	{
		ssdServermodelpage = new SSDServermodelPage();
	...
	public void ToVerifyMixedResultsDisplays()
	{
		...
		String ActualSSDRequirmentLabel = "2 -  SSDs meet your requirements";
	...
	public void ToVerifyRefineYourResults()
	{
		...
		//System.out.println(ssdResultpage.ResultWriteSSDSelected() + "Write Intensive Not is Selected");
