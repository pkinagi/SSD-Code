...
public class SSDWriteSelect extends BaseClass
{
	...
	public SSDWriteSelect()
	{
		super();
	}
	
	@BeforeTest(description = "For Launching the browser")
	//@Test (priority = 0)
	public void LetStart()
	{
		...
		log.info("Successfully URL is Launched");
	...
	{
		ssdWorkloadpage = new SSDWorkloadPage();
		ssdWorkloadpage.SelectWriteALL();
		driver.manage().timeouts().pageLoadTimeout(10, TimeUnit.SECONDS);
	...
	public void ToVerifySelectedWorkloadDisplays()
	{
		ssdServermodelpage = new SSDServermodelPage();
		driver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS);
		ssdServermodelpage.WriteTargetLoadDisplays();
	...
	@Test(priority = 8)
	public void ToVerifySelectWriteServerType()
	{
		ssdServermodelpage = new SSDServermodelPage();
		driver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS);
		Assert.assertTrue(ssdServermodelpage.WriteServerType(), "Server Type List is displayed");
	}
	@Test(priority = 9)
	public void ToVerifySelectWriteServerModelType()
	{
		ssdServermodelpage = new SSDServermodelPage();
		ssdServermodelpage.WriteServerModelType();
		driver.manage().timeouts().pageLoadTimeout(20, TimeUnit.SECONDS);
	...
	public void ToVerifyMixedResultsDisplays()
	{
		...
		String ActualSSDRequirmentLabel = "4 -  SSDs meet your requirements";
	...
	public void ToVerifyRefineYourResults()
	{
		...
		Assert.assertTrue(ssdResultpage.ResultWriteSSDSelected(), "Write Use is Selected");
		System.out.println(ssdResultpage.ResultWriteSSDSelected() + "Write Use is Selected");
	...
	public void ToVerifyBrowserBackButton()
	{
		...
		String ActualHomePageURL = "https://ssdhpestage.azurewebsites.net/index";
